...
# Modifications par davcail (version 1.0.8)
- Creation d'un exemple programme avec 
	- suppression Emon et remplacement par Mqtt (Emoncms accepte Mqtt)
	- ajout horloge NTP
	- testé avec un compteur Base (ancienne génération) et un compteur Tempo (linky)
